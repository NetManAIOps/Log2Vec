...
# * Last modified : 2019-01-08 18:59
...
if __name__ == '__main__':
    ...
    parser.add_argument('-template_file', help = 'template_file', type = str, default = 'M2_template.txt')
    parser.add_argument('-syn_file',help = 'syn_file', type = str, default = 'M2_synonyms.txt')
    parser.add_argument('-ant_file',help = 'ant_file', type = str, default = 'M2_antonyms.txt')
